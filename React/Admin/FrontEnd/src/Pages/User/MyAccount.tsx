                                                        ...
                                                        <Card.Body >
                                                            ...
                                                            <div className="d-flex mb-4">
                                                                ...
                                                                <div className="flex-shrink-0">
                                                                    <Link to="#" className="badge bg-dark-subtle text-body">Edit</Link>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <Row className="mt-4">
                                                                <Col md={6}>
                                                                    <Card className="mb-md-0">
                                                                        <Card.Body >
                                                                            <div className="float-end clearfix"> <Link to='/shop/address' className="badge bg-primary-subtle text-primary"><i className="ri-pencil-fill align-bottom me-1"></i> Edit</Link> </div>
                                                                            <div>
                                                                            ...
                                                                            (wishlishProduct || [])?.map((item, inx) => {
                                                                                return (
                                                                                    <tr key={inx}>
                                                                                        ...
                                                                                        <td>${item.price}</td>
                                                                                        <td><span className={`badge bg-${item.color}-subtle text-${item.color}`}>{item.status}</span></td>
                                                                                        <td>
                                                                ...
                                                                <Row>
                                                                    ...
                                                                    <Col lg={6}>
                                                                        <div className="mb-3">
                                                                            ...
                                                                            <Form.Control type="text" id="firstnameInput" placeholder="Enter your firstname" defaultValue="Raquel" name="firstname" />
                                                                        </div>
                                                                    </Col>
                                                                    <Col lg={6}>
                                                                        <div className="mb-3">
                                                                            <Form.Label htmlFor="lastnameInput">Last Name</Form.Label>
                                                                            <Form.Control type="text" id="lastnameInput" placeholder="Enter your lastname" defaultValue="Murillo" name="lastname" />
                                                                        </div>
                                                                    </Col>
                                                                    <Col lg={6}>
                                                                        <div className="mb-3">
                                                                            <Form.Label htmlFor="phonenumberInput">Phone Number</Form.Label>
                                                                            <Form.Control type="text" id="phonenumberInput" placeholder="Enter your phone number" defaultValue="+(253) 01234 5678" name="phno" />
                                                                        </div>
                                                                    </Col>
                                                                    <Col lg={6}>
                                                                        <div className="mb-3">
                                                                            <Form.Label htmlFor="emailInput">Email Address</Form.Label>
                                                                            <Form.Control type="email" id="emailInput" placeholder="Enter your email" defaultValue="raque@toner.com" name="email" />
                                                                        </div>
                                                                    </Col>
                                                                    <Col lg={4}>
                                                                        <div className="mb-3">
                                                                    ...
                                                                    <Col lg={4}>
                                                                        <div className="mb-3">
                                                                            ...
                                                                            <Form.Control type="text" minLength={5} maxLength={6} id="zipcodeInput" placeholder="Enter zipcode" defaultValue="90011" name="zip" />
                                                                        </div>
                                                                    </Col>
                                                                    <Col lg={12}>
                                                                        <div className="mb-3 pb-2">
                                                                            <Form.Label htmlFor="exampleFormControlTextarea">Description</Form.Label>
                                                                            <Form.Control name="desc" as="textarea" id="exampleFormControlTextarea" placeholder="Enter your description" rows={3} defaultValue="Hi I'm Raquel Murillo, It will be as simple as Occidental; in fact, it will be Occidental. To an English person, it will seem like simplified English, as a skeptical Cambridge friend of mine told me what Occidental is European languages are members of the same family."></Form.Control>
                                                                        </div>
                                                                    </Col>
                                                                </Row>
                                                            </form>
                                                                    ...
                                                                    <Row className="g-2">
                                                                        <Col lg={4}>
                                                                            <div>
                                                                                ...
                                                                                <Form.Control type="password" id="oldpasswordInput" placeholder="Enter current password" name="opassword" autoComplete="off"/>
                                                                            </div>
                                                                        </Col>
                                                                        <Col lg={4}>
                                                                            <div>
                                                                                <Form.Label htmlFor="newpasswordInput" >New Password*</Form.Label>
                                                                                <Form.Control type="password" id="newpasswordInput" placeholder="Enter new password" name="npassword" autoComplete="off"/>
                                                                            </div>
                                                                        </Col>
                                                                        <Col lg={4}>
                                                                            <div>
                                                                                <Form.Label htmlFor="confirmpasswordInput" >Confirm Password*</Form.Label>
                                                                                <Form.Control type="password" id="confirmpasswordInput" placeholder="Confirm password" name="cpassword" autoComplete="off"/>
                                                                            </div>
                                                                        </Col>
                                                                        <Col lg={12}>
                                                                            <div className="mb-3">
