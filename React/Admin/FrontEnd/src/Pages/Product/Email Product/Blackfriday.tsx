                                ...
                                <tbody><tr>
                                    ...
                                    <td style={{ padding: "8px", verticalAlign: "top", textAlign: "center" }}>
                                        <div style={{ position: "relative" }}>
                                            ...
                                            <Link to="#">
                                                <h6 style={{ fontSize: "15px", margin: " 10px 0", fontWeight: 600, fontFamily: "'Inter', sans-serif", color: "#0d355d" }}>Furniture &amp; Decor</h6>
                                            </Link>
                                        </div>
                                    </td>
                                </tr>
                                ...
                                <tbody><tr>
                                    ...
                                    <td style={{ padding: "8px", verticalAlign: "top", textAlign: "center" }}>
                                        <div style={{ position: "relative" }}>
                                            ...
                                            <Link to="#">
                                                <h6 style={{ fontSize: "15px", margin: "10px 0", fontWeight: 600, fontFamily: "'Inter', sans-serif", color: "#daedff" }}>Furniture &amp; Decor</h6>
                                            </Link>
                                        </div>
                                    </td>
                                </tr>
