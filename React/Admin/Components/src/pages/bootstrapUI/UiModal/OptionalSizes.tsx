        ...
        <React.Fragment>
            ...
            >
                <Modal.Header className="modal-title fw-bold"
                    ...
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_fullscreen(false)}></button>
                </Modal.Header>
                <Modal.Body>
            ...
            >
                <Modal.Header className="modal-title fw-bold"
                    ...
                    Extra large modal
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_xlarge(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <h6 className="fs-16">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            >
                <Modal.Header className="modal-title fw-bold"
                    ...
                    Large Modal
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_large(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <h6 className="fs-16">Give your text a good structure</h6>
                    <div className="d-flex">
            ...
            >
                <Modal.Header className="modal-title fw-bold"
                    ...
                    Small Modal
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_small(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <h6 className="fs-16">Give your text a good structure</h6>
                    <div className="d-flex">
