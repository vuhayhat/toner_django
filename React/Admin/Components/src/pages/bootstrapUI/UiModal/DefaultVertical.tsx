        ...
        <React.Fragment>
            ...
            <Modal id="myModal" show={modal_standard} onHide={() => { tog_standard(); }} >
                <Modal.Header className="modal-title fw-bold" id="myModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_standard()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-14">
            ...
            >
                <Modal.Header
                    ...
                    Center Modal
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_center(false)}></button>
                </Modal.Header>
