        ...
        <React.Fragment>
            ...
            >
                <Modal.Header className="modal-title fw-bold">
                    Grid Modals
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_grid(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <form action="#">
            ...
            >
                ...
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_backdrop(false)}></button>
                </Modal.Header>
