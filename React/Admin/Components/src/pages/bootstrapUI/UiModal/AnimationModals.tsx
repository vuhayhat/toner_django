        ...
        <React.Fragment>
            ...
            <Modal id="fadeInRightModal" show={modal_animationRight} onHide={() => { tog_animationRight(); }} className="fadeInRight" centered >
                <Modal.Header className="modal-title fw-bold" id="fadeInRightModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_animationRight()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-16">
            ...
            <Modal id="fadeInleftModal" show={modal_animationLeft} onHide={() => { tog_animationLeft(); }} className="fadeInLeft" centered >
                <Modal.Header className="modal-title fw-bold" id="fadeInleftModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_animationLeft()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="fadeInUpModal" show={modal_animationUp} onHide={() => { tog_animationUp(); }} className="fadeInUp" centered >
                <Modal.Header className="modal-title fw-bold" id="fadeInUpModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_animationUp()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="flipModal" show={modal_animationFlip} onHide={() => { tog_animationFlip(); }} className="flip" centered >
                <Modal.Header className="modal-title fw-bold" id="flipModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_animationFlip()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
            ...
            <Modal id="flipModal" show={modal_animationZoom} onHide={() => { tog_animationZoom(); }} className="zoomIn" centered >
                <Modal.Header className="modal-title fw-bold" id="flipModalLabel">
                    Modal Heading
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => tog_animationZoom()}></button>
                </Modal.Header>
                <Modal.Body>
                    <h5 className="fs-16">
                        Overflowing text to show scroll behavior
