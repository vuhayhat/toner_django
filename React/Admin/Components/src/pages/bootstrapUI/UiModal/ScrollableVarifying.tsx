        ...
        <React.Fragment>
            ...
            >
                <Modal.Header className="modal-title fw-bold" id="exampleModalScrollableTitle">
                    Scrollable modal
                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_scroll(false)}></button>
                </Modal.Header>
                <Modal.Body>
            ...
            >
                <Modal.Header className="modal-title fw-bold" id="exampleModalLabel">
                    New message to Mary
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_varying1(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <form>
                        <div className="mb-3">
            ...
            >
                <Modal.Header className="modal-title fw-bold">
                    ...
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_varying2(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <form>
                        <div className="mb-3">
            ...
            >
                <Modal.Header className="modal-title fw-bold">
                    ...
                    <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={() => setmodal_varying3(false)}></button>
                </Modal.Header>
                <Modal.Body>
                    <form>
                        <div className="mb-3">
