            ...
            <Row>
                ...
                <Col xxl={4} xl={6}>
                    <Card>
                        ...
                        <Card.Body>
                            <p>Add nearly any HTML within, even for linked list groups like the one below, with the help of <Link to="https://getbootstrap.com/docs/5.1/utilities/flex/">flexbox utilities</Link>.</p>
