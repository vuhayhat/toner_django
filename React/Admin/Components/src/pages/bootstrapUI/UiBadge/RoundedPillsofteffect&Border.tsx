            ...
            <Row>
                <Col xxl={6}>
                    <Card>
                        ...
                        <Card.Body>
                            <p className="text-muted">Use the <code>rounded-pill bg-*-subtle</code> class with the below-mentioned variation to create a badge more rounded with a soft background.</p>
                    ...
                    <Card>
                        ...
                        <Card.Body>
                            <p className="text-muted">
                                Use the <code>badge-border</code> and <code>bg-*-subtle</code> with below
