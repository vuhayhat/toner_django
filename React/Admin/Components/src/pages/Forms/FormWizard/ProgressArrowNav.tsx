                                            ...
                                            <Tab.Pane eventKey="0" id="pills-gen-info" role="tabpanel" aria-labelledby="pills-gen-info-tab">
                                                <div>
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <Form.Control type="password" id="gen-info-password-input" placeholder="Enter Password" autoComplete='off' />
                                                    </div>
                                                </div>
                                                ...
                                                <div>
                                                    <div className="text-center">
                                                        <div className="profile-user position-relative d-inline-block mx-auto mb-2">
                                                            {/* {image ?
                                                                <img src={image} className="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image"/>
                                                                :
                                                                <img src={dummyUser} className="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile-image" />
                                                            } */}
                                                            <img src={dummyUser} className="rounded-circle avatar-lg img-thumbnail user-profile-image" alt="user-profile" />

                                                            <div className="avatar-xs p-0 rounded-circle profile-photo-edit">
                                                                <input id="profile-img-file-input" type="file" className="profile-img-file-input" accept="image/png, image/jpeg, image/jpg" />
                                                    ...
                                                    <div>
                                                        ...
                                                        <Form.Control  as="textarea" placeholder="Enter Description" id="gen-info-description-input" rows={2}/>
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                            ...
                                            <Tab.Pane eventKey="1">
                                                <div>
                                                    ...
                                                    <div className="mb-3">
                                                        ...
                                                        <Form.Control type="password" id="steparrow-gen-info-password-input" placeholder="Enter Password" autoComplete='off' />
                                                    </div>
                                                    <div>
                                                        <Form.Label htmlFor="steparrow-gen-info-confirm-password-input">Confirm Password</Form.Label>
                                                        <Form.Control type="password" id="steparrow-gen-info-confirm-password-input" placeholder="Enter Confirm Password" autoComplete='off' />
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-start gap-3 mt-4">
                                            ...
                                            <Tab.Pane eventKey="2">
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        <Form.Control as="textarea" placeholder="Enter Description" id="des-info-description-input" rows={3}></Form.Control>
                                                    </div>
                                                </div>
                                                <div className="d-flex align-items-start gap-3 mt-4">
