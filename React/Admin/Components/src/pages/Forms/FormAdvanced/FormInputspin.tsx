...
const FormInputspin = () => {
    ...
    const [defaultCounter, setdefaultCounter] = useState(2);
    const [lightCounter, setlightCounter] = useState(5);
    const [fullwidthCounter, setfullwidthCounter] = useState(4);
    const [lfullwidthCounter, setlfullwidthCounter] = useState(6);
    const [blueCounter, setblueCounter] = useState(6);
    const [skyCounter, setskyCounter] = useState(1);
    const [greenCounter, setgreenCounter] = useState(3);
    const [tealCounter, settealCounter] = useState(1);
    const [yellowCounter, setyellowCounter] = useState(4);
