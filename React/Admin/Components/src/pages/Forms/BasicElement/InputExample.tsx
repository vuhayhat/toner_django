                                ...
                                <Row className="gy-4">
                                    <Col xxl={3} md={6}>
                                        <Form>
                                            ...
                                            <Form.Control type="password" id="basiInput" autoComplete='off' />
                                        </Form>
                                    </Col>
                                    ...
                                    <Col xxl={3} md={6}>
                                        <Form>
                                            ...
                                            <Form.Control type="password" id="labelInput" autoComplete='off' />
                                        </Form>
                                    </Col>
                                    ...
                                    <Col xxl={3} md={6}>
                                        <Form>
                                            ...
                                            <Form.Control type="password" id="placeholderInput" placeholder="Placeholder" autoComplete='off' />
                                        </Form>
                                    </Col>
                                    ...
                                    <Col xxl={3} md={6}>
                                        <Form>
                                            ...
                                            <Form.Control type="password" id="formtextInput" autoComplete='off' />
