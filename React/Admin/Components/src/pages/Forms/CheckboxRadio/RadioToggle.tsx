            ...
            <Row>
                <Col lg={6}>
                    <Card>
                        ...
                        <Card.Body>
                            <p className="text-muted">Create button-like checkboxes and radio buttons by using <code>btn</code> styles rather than form-check-label class on the &lt;label&gt; elements. These toggle buttons can further be grouped in a <Link to="https://getbootstrap.com/docs/5.1/components/button-group/">button group</Link> if needed.</p>
