                        ...
                        <Card.Body>
                            ...
                            <Form action="#">
                                <Row className="g-3">
                                    ...
                                    <Col lg={4}>
                                        <div className="form-floating">
                                            <Form.Control type="password" id="passwordfloatingInput" placeholder="Enter your password" autoComplete='off' />
                                            <Form.Label htmlFor="passwordfloatingInput">Password</Form.Label>
                                        </div>
                                    </Col>
                                    <Col lg={4}>
                                        <div className="form-floating">
                                            <Form.Control type="password" id="passwordfloatingInput1" placeholder="Confirm password" autoComplete='off' />
