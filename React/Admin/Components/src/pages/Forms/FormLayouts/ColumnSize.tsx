                    ...
                    <Card>
                        ...
                        <Card.Body>
                            ...
                            <Row className="g-3">
                                ...
                                <Col sm={4}>
                                    <Form>
                                        <Form.Control type="password" placeholder="Password" aria-label="Password" autoComplete='off' />
                                    </Form>
                                </Col>
                                <Col sm={4}>
                                    <Form>
                                        <Form.Control type="password" placeholder="Confirm Password" aria-label="confirm-password" autoComplete='off' />
                                    </Form>
                                </Col>
                                <Col sm={7}>
