                        ...
                        <Card>
                            ...
                            <Card.Body>
                                <Card className="border-0 shadow-none mb-0">
                                    ...
                                    <Card.Body>
                                        <div className="mt-n5">
                                            <Image src={avatar1} alt="" className="avatar-lg rounded-circle p-1 bg-body mt-n3" />
                                        </div>
                                    </Card.Body>
                                            ...
                                            <Col xl={3} md={5}>
                                                ...
                                                <div>
                                                    ...
                                                    <ul className="d-flex gap-2 flex-wrap list-unstyled mb-0">
                                                        <li>
                                                            <span className="badge bg-dark-subtle text-body">Business Marketing</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-dark-subtle text-body">Google Ads Management</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-dark-subtle text-body">Social Ads Management</span>
                                                        </li>
                                                        <li>
                                                            <span className="badge bg-dark-subtle text-body">Content SEO</span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Col>
