            ...
            <Card>
              ...
              <Card.Body>
                ...
                <Row className="g-4">
                  <Col lg={3}>
                    <div className="text-center">
                      <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="40"><CountUp end={674.3} prefix="$" suffix="k" decimals={1} decimal='.'/></span></h4>
                  ...
                  <Col lg={3}>
                    <div className="text-center">
                      <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="40"><CountUp end={1030.35} suffix="M" separator=',' decimals={2} decimal='.'/></span></h4>
                      <p className="text-muted fs-14 mb-0">Customers</p>
                    </div>
                  </Col>
                  <Col lg={3}>
                    <div className="text-center">
                      <h4 className="fs-22 fw-semibold mb-3"><span className="counter-value" data-target="40"><CountUp end={165.89} prefix="$" suffix="k" decimals={2} decimal='.'/></span></h4>
