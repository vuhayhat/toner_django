                                ...
                                <Table className="align-middle table-nowrap mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>$450</td>
                                            <td>
                                                <ProgressBar variant="success" now={100} className="progress-xs" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>$860</td>
                                            <td>
                                                <ProgressBar variant="warning" now={65} className="progress-xs" />
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>$450</td>
                                            <td>
                                                <ProgressBar variant="warning" now={35} className="progress-xs" />
                                            </td>
                                            <td><Button bsPrefix='a' href="#" className="link-warning">Waiting</Button></td>
                                        </tr>
                                    </tbody>
