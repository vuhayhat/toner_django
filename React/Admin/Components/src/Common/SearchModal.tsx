                ...
                <div className="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0 overflow-hidden" ref={searchDropdown} id="search-dropdown">
                    ...
                    <div className="dropdown-head rounded-top">
                        ...
                        <div className="dropdown-item bg-transparent text-wrap">
                            <Link to="/index" className="btn btn-soft-secondary btn-sm btn-rounded">how to setup <i className="mdi mdi-magnify ms-1 align-middle"></i></Link>
                            <Link to="/index" className="btn btn-soft-secondary btn-sm btn-rounded">buttons <i className="mdi mdi-magnify ms-1 align-middle"></i></Link>
                        </div>
                    </div>
