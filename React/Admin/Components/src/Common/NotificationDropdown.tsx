                ...
                <div className="dropdown-head rounded-top">
                    <div className="p-3 border-bottom border-bottom-dashed">
                        <Row className="align-items-center">
                            <Col>
                                <h6 className="mb-0 fs-16 fw-semibold"> Notifications <span className="badge badge-danger-subtle fs-13 notification-badge"> 4</span></h6>
                                <p className="fs-14 mt-1 mb-0 text-muted">You have <span className="fw-semibold notification-unread">3</span> unread messages</p>
                            </Col>
