                        ...
                        {!item['isHeader'] ?
                            (item.subItems ? (
                                <li className="nav-item">
                                    ...
                                    <Collapse
                                        className={item.id === "bootstrapui" && item.subItems.length > 8 ? "menu-dropdown mega-dropdown-menu" : "menu-dropdown"} in={item.stateVariables}>
                                        {/* subItms  */}
                                        {item.id === "bootstrapui" && item.subItems.length > 8 ? (
                                            <React.Fragment>
                                                <Collapse className='menu-dropdown mega-dropdown-menu' in={item.stateVariables}>
                                                    <div>
                                                        <Row id="sidebarApps">
